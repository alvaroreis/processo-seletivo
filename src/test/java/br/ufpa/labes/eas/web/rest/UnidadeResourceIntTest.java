...
public class UnidadeResourceIntTest {
    ...
    public void setup() {
        ...
        final UnidadeResource unidadeResource = new UnidadeResource(unidadeRepository);
    ...
    public void createUnidade() throws Exception {
        ...
        assertThat(testUnidade.getTelefone()).isEqualTo(DEFAULT_TELEFONE);
        assertThat(testUnidade.getAbreviacao()).isEqualTo(DEFAULT_ABREVIACAO);
    }
    ...
    public void updateUnidade() throws Exception {
        ...
        assertThat(testUnidade.getTelefone()).isEqualTo(UPDATED_TELEFONE);
        assertThat(testUnidade.getAbreviacao()).isEqualTo(UPDATED_ABREVIACAO);
    }
