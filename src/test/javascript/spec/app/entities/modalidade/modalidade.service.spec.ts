...
describe('Service Tests', () => {
    describe('Modalidade Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Modalidade(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Modalidade', async () => {
            ...
            it('should update a Modalidade', async () => {
                const returnedFromService = Object.assign(
                    {
                        nome: 'BBBBBB'
                    },
            ...
            it('should return a list of Modalidade', async () => {
                const returnedFromService = Object.assign(
                    {
                        nome: 'BBBBBB'
                    },
            ...
            it('should delete a Modalidade', async () => {
